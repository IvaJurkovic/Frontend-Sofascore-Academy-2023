...
export default function Input() {
  ...
  const onClick = (e: React.SyntheticEvent) => {
    ...
    // store new circle in your state and then reset the selector to default radius - DONE
    // get your next circle parameters other than radius with `getRandomCircleParameters` method - DONE
  ...
  return (
    <div style={{margin: '0 auto'}}>
      <form>
        ...
        <input
          // add onChange method to this input element, which takes form value and sets it into current radius state - DONE
          type="range"
          step="1"
          id="radius"
          ...
          max="150"
          value={currentRadius}
          onChange={(e) => setCurrentRadius(e.target.valueAsNumber)}
        />
        </label>
